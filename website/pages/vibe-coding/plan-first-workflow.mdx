...
In the [previous section](/vibe-coding) you used `Shift+Tab` to switch to Plan mode -- a quick way to ask Claude to show its approach before acting. That works well for focused tasks like "add a filter to the dashboard."
