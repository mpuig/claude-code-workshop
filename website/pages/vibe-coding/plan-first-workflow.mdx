...
description: How to separate planning from execution when building complex features with Claude Code, so you stay in control of every important decision.
---
...
In the [previous section](/vibe-coding) you used `Shift+Tab` to switch to Plan mode -- a quick way to ask Claude Code to show its approach before acting. That works well for focused tasks like "add a filter to the dashboard."
...
Proceed to [Building Skills](/vibe-coding/building-skills) to learn how to package repeatable workflows into reusable skill files.
