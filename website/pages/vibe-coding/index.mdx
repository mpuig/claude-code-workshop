---
title: "Module 3: Building an Insurance App with Vibe Coding"
description: Build a Claims Dashboard app using natural language -- no coding experience required.
---
...
For any of these, the approach is the same: describe what you want, let Claude build it, iterate until it is right. For medium and advanced projects, consider the [Plan First workflow](/vibe-coding/plan-first-workflow) to stay in control as complexity grows. If you find yourself repeating the same workflows, package them as [reusable skills](/vibe-coding/building-skills).
