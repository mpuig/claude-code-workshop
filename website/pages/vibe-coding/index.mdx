...
> **Bonus:** If you finish early, try the [FWA Assessor Portal](fwa-assessor-portal) — a more advanced exercise where you build a multi-agent investigation portal (60 min).
