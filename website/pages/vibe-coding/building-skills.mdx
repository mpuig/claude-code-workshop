...
description: Learn what skills are, how to structure them, and best practices for creating repeatable insurance workflows that Claude can follow consistently.
---

# Building Skills for Claude Code

> **Type:** Reference | **Prerequisites:** [Building an Insurance App](/vibe-coding)

![Skills: Customize Claude Code to your Enterprise](./images/skills-overview.png)
...
| `~/.claude/skills/` (Mac/Linux) or `%USERPROFILE%\.claude\skills\` (Windows) | All Claude Code projects on your machine | Place skill folder in directory |
| `.claude/skills/` (in project) | Only this specific project | Place skill folder in project |

For more on how skills work across Claude's different interfaces, see [Appendix A: Claude Cowork](/appendix/claude-cowork#plugins-and-skills).
