...
> **Tip:** Before clearing, ask Claude Code to save any important outputs to a file. That way you keep the results without keeping the full conversation history.
