...
<img src="/images/insurance-workflows/loss-ratio-by-region.png" alt="Loss ratio by region bar chart" style={{width: '100%', borderRadius: '4px', border: '1px solid #e0e0e0'}} />
</a>
...
<img src="/images/insurance-workflows/quarterly-trend-worst-regions.png" alt="Quarterly trend line chart" style={{width: '100%', borderRadius: '4px', border: '1px solid #e0e0e0'}} />
</a>
...
<img src="/images/insurance-workflows/loss-ratio-heatmap.png" alt="Loss ratio heatmap by region and segment" style={{width: '100%', borderRadius: '4px', border: '1px solid #e0e0e0'}} />
</a>
