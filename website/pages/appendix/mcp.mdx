...
| <Os code mac="~/.claude.json" win="%USERPROFILE%\.claude.json" /> | All your projects | No (local) | Personal servers across projects |
...
|-------|------|---------|------------|
| **Local** (default) | `--scope local` | <Os code mac="~/.claude.json" win="%USERPROFILE%\.claude.json" /> under project path | You only, this project only |
| **Project** | `--scope project` | `.mcp.json` in project root | Entire team via version control |
| **User** | `--scope user` | <Os code mac="~/.claude.json" win="%USERPROFILE%\.claude.json" /> globally | You only, all projects |
...
| <Os code mac="~/.claude.json" win="%USERPROFILE%\.claude.json" /> | Code CLI (+ Code Tab) |
| `.mcp.json` (project) | Code CLI only |
| `claude mcp add` | Code CLI only (stored in <Os code mac="~/.claude.json" win="%USERPROFILE%\.claude.json" /> or `.mcp.json`) |
