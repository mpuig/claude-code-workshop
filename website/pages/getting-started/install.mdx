...
For non-technical executive users, start with [Exercise 0: Executive Onramp (Zero to One)](/exercises/executive-onramp).
Then proceed to [Module 1.1: First Steps with Claude Code](/fundamentals/first-steps) to learn how to give effective instructions and complete your first insurance tasks.
