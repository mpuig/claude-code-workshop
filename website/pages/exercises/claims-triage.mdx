...
1. Create a folder for this exercise (e.g. `claims-triage/`) and inside it create a subfolder called `data/`
2. Download the three data files into the `data/` folder:
   - [incoming_claims.csv](../data/exercise-3/incoming_claims.csv) | [historical_outcomes.csv](../data/exercise-3/historical_outcomes.csv) | [business_rules.json](../data/exercise-3/business_rules.json)
3. Open your terminal in the `claims-triage/` folder and start Claude Code
...
![Exercise 3 final browser result](./images/exercise-2-screenshot.png)
