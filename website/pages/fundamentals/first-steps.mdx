---
title: "Module 2.1: First Steps with Claude Code"
...
> **Time:** 30 minutes | **Prerequisites:** Claude Code installed and authenticated ([Quick Start](/getting-started/install))

## What You Will Learn

- How to give Claude Code instructions in natural language
- How to reference files so Claude Code can read them
...
```text
Summarize the key findings in @<Os code mac="/Users/yourname/Documents/mig-claims-q3-2024.csv" win="C:\Users\yourname\Documents\mig-claims-q3-2024.csv" />
```
...
Download the sample report: [claims-report.pdf](../data/claims-report.pdf). Then reference it in Claude Code:
...
Proceed to [Module 2.2: Project Memory with CLAUDE.md](/fundamentals/project-memory) to learn how to give Claude Code persistent context about your projects and preferences.
