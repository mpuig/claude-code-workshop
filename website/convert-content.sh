...
add_frontmatter_and_copy \
  ...
  "Install Claude Code, authenticate, and run your first session in 10 minutes."
...
add_frontmatter_and_copy \
  ...
  "Learn how to give Claude instructions in natural language, reference files, and complete three insurance scenarios."
...
add_frontmatter_and_copy \
  ...
  "Learn how to use CLAUDE.md to give Claude persistent context about your projects and preferences."
...
add_frontmatter_and_copy \
  ...
  "Use Claude Code to analyze a commercial property portfolio and generate a professional underwriting brief."
...
add_frontmatter_and_copy \
  ...
  "Module 2.2: Loss Ratio Analysis" \
  "Analyze motor portfolio loss ratios across Spanish regions with Claude Code."
...
add_frontmatter_and_copy \
  ...
  "Use Claude Code web search to build a market entry assessment for Portugal expansion."
...
# Exercise 1
add_frontmatter_and_copy \
  "$REPO_ROOT/exercises/exercise-1-executive-onramp/README.md" \
...
# Exercise 2
add_frontmatter_and_copy \
  "$REPO_ROOT/exercises/exercise-2-data-insight-tool/README.md" \
...
# Exercise 3
add_frontmatter_and_copy \
  "$REPO_ROOT/exercises/exercise-3-claims-triage/README.md" \
...
# Exercise 4
add_frontmatter_and_copy \
  "$REPO_ROOT/exercises/exercise-4-automated-reporting/README.md" \
