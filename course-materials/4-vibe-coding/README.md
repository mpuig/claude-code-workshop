...
Non-technical professionals are building real, functional applications this way. In this module, you will build a working insurance application from scratch.
...
> **Bonus:** If you finish early, try the [FWA Assessor Portal](fwa-assessor-portal.md) — a more advanced exercise where you build a multi-agent investigation portal (60 min).
