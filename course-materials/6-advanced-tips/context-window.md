...
This is why CLAUDE.md is so valuable ([Module 2.2](/fundamentals/project-memory)). It ensures that essential project context survives a `/clear`. Put any instructions you want Claude Code to always follow into CLAUDE.md rather than repeating them in conversation.
