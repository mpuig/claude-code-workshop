...
Here is a simple example. Suppose Claude updates a claims summary:
...
When Claude shows you a diff in **Edit mode**:
...
> **Tip:** If you are unsure about a change, ask Claude to explain before accepting. You can say: "Walk me through each change in that diff before I accept it."
...
- Ask Claude Code to explain changes if anything looks unexpected
