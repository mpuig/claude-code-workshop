...
Mediterranean Insurance Group operates five principal lines of business across its four-country footprint. Product design reflects the regulatory environments of Spain, Portugal, Italy, and France, with local adaptations layered on top of a group-level product framework.
...
| Tier | Name | Third-Party Liability | Theft | Own Damage | Roadside Assistance | Legal Protection | Windshield | Avg Annual Premium |
|---|---|---|---|---|---|---|---|---|
| Basic | "Esencial" | Mandatory limits | No | No | No | No | No | EUR 285 |
| Standard | "Confort" | Enhanced limits | Yes | Partial (named perils) | Yes | Yes | Yes | EUR 438 |
| Premium | "Total" | Maximum limits | Yes | Full comprehensive | Yes (premium) | Yes | Yes + no excess | EUR 625 |

**Key rating factors:**
- Driver age and experience (years since license)
...
| Product | Description | % of Home GWP | Avg Premium |
|---|---|---|---|
| **Homeowner** | Building and contents cover for owner-occupied properties | 65% | EUR 580 |
| **Renter** | Contents-only cover for tenants | 20% | EUR 215 |
| **Landlord** | Building cover + rental income protection for property investors | 15% | EUR 890 |

### Policy Structure -- Homeowner

**Coverage tiers:**

| Tier | Name | Building | Contents | Liability | Water Damage | Theft | Natural Catastrophe | Avg Annual Premium |
|---|---|---|---|---|---|---|---|---|
| Basic | "Hogar Basico" | Up to EUR 150K | Up to EUR 20K | EUR 300K | Yes | No | Government scheme only | EUR 320 |
| Standard | "Hogar Plus" | Up to EUR 300K | Up to EUR 50K | EUR 600K | Yes | Yes | Yes (sublimit) | EUR 580 |
| Premium | "Hogar Premium" | Up to EUR 500K | Up to EUR 100K | EUR 1M | Yes (first-loss) | Yes (extended) | Yes (full) | EUR 875 |

**Key rating factors:**
- Property type (apartment, townhouse, detached, rural finca)
- Construction year and materials
- Square meters and number of rooms
- Geographic zone (flood, wildfire, and subsidence risk mapping using 200m-grid resolution)
- Sum insured (building and contents separately)
- Security features (alarm, reinforced door, gated community)
- Claims history
...
**Strategic notes:**
- Bancassurance partnerships (with CaixaBank in Spain and BPI in Portugal) account for 35% of home insurance sales.
- Climate risk is a growing concern: wildfire claims in southern Spain and Portugal increased 42% in 2025 vs. 2023. MIG introduced a wildfire risk surcharge in high-exposure zones in Q3 2025.
- The renter segment is underpenetrated and represents a growth opportunity, especially among younger urban populations.
...
- Geographic zone (provider network density affects pricing)
- Pre-existing conditions (underwritten at inception for individual policies; guaranteed issue for group above 25 lives)
- Family composition (discounts for 3+ family members)
- Copay election (higher copay = lower premium; options: EUR 0, EUR 10, EUR 20 per visit)
...
|---|---|---|
| Property Damage | Fire, explosion, natural events, water damage | EUR 500K - EUR 2M |
| Business Interruption | Loss of income during reinstatement period | 12-month indemnity period |
| General Liability | Third-party bodily injury and property damage | EUR 1M - EUR 3M |
| Employer's Liability | Workplace injury cover (where applicable by jurisdiction) | Statutory limits |
| Theft | Burglary and robbery of stock and equipment | EUR 30K - EUR 150K |
| Electronic Equipment | IT and electronic equipment breakdown | EUR 20K - EUR 100K |

**Key rating factors:**
- Business activity (classified using NACE codes; 340 risk classes)
- Turnover and number of employees
- Property characteristics (construction, age, fire protection, location)
- Claims history (3-year experience)
- Sum insured and deductible election
- Risk engineering assessment (mandatory for mid-market accounts above EUR 10K premium)
...
| Product | Description | % of Life GWP | Avg Premium |
|---|---|---|---|
...
| Tier | Sum Assured Range | Medical Underwriting | Key Features | Avg Annual Premium |
|---|---|---|---|---|
...
**Key rating factors:**
- Age at entry
- Gender (where permitted by jurisdiction; unisex pricing in the EU since 2012)
- Smoking status
- Sum assured and policy term
- Health history and BMI
- Occupation class (4 classes: clerical, manual, hazardous, special)
...
**Strategic notes:**
- Life insurance is viewed as a "maintain" business rather than a growth priority. The low-interest-rate environment of the 2010s eroded savings product margins, and recovery has been slow.
- Mortgage life is tightly coupled to bancassurance partnerships and property market cycles.
- MIG is exploring a digital-first term life product ("MIG Vida Express") with instant underwriting for sums up to EUR 150K, targeting the 30-45 age demographic. Launch planned for Q3 2026.

---

## Cross-Sell and Bundling

MIG actively promotes multi-product bundling. Key metrics:
...
| Channel | % of GWP | Key Lines | Trend |
|---|---|---|---|
| Tied Agents | 35% | Motor, Home | Stable |
| Independent Agents | 20% | Motor, Home, Life | Slight decline |
| Brokers | 18% | Commercial Property, Fleet | Growing |
| Bancassurance | 12% | Life, Home | Stable |
| Direct Digital | 10% | Motor, Renter | Growing fast (+18% YoY) |
| Partnerships / Affinity | 5% | Health (corporate), Travel | Growing |
